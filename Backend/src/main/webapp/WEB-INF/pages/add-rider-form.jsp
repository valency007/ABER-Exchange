...
<body>
<h1 style="text-align:center;">Add New Rider</h1>
<div class="container">
<form:form method="POST" commandName="rider" action="${pageContext.request.contextPath}/admin/rider/add.html" onsubmit="pwd_handler(this);">
