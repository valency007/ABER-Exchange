...
<h1 style = "text-align:center;">Edit Order page</h1>
<div class = "container">
<form:form method="POST" commandName="order" action="${pageContext.request.contextPath}/admin/edit/${order.id}.html">
<form:input path="name" />
		...
		<form:input path="rider" placeholder="UNASSIGNED - Default" />
		<form:input path="status" placeholder = "Status: Done(1) or Pending(0)" />
