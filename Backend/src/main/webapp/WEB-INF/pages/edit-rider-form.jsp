...
<title>Edit Rider Data</title>
</head>



<body>
<h1 style = "text-align:center;">Edit Rider Information</h1>
<div class="container">
<form:form method="POST" commandName="rider" action="${pageContext.request.contextPath}/admin/rider/edit/${rider.id}.html" onsubmit="pwd_handler(this);">
