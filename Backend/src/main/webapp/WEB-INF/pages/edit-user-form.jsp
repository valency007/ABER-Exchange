...
<div class="container">
<form:form method="POST" commandName="user" action="${pageContext.request.contextPath}/admin/user/edit/${user.uid}.html">
<form:input path="fname" placeholder="First Name"/>
		<form:input path="lname" placeholder="Last Name"/>
		<form:input path="email" placeholder="Email"/>
		<form:input path="password" placeholder="Password"/>
		<form:input path="contact_number" placeholder="Contact Number"/>
		<form:input path="credit" placeholder="User Credits"/>
