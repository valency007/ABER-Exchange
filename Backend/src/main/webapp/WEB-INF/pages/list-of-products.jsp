...
<meta http-equiv="refresh" content="10; URL=${pageContext.request.contextPath}/admin/products">
...
<h1 style = "text-align:center; ">Products | <a style="display: inline-block; margin: 10px 0; vertical-align: middle;" href="${pageContext.request.contextPath}/admin/list" class="myButton"><i class="fa fa-external-link"></i> BACK TO DASHBOARD </a></h1> 	
...
<tr>
<th width="5%">ID</th><th width="15%">Title</th><th width="15%">Description</th><th width="15%">Category</th><th width="15%">Price(A$)</th><th width="10%">Donation</th><th width="15%">Image</th><th width="10%">Actions</th>
</tr>
</thead>
<tbody>
...
<tr style="padding-top: 2px;">
	<td style="text-align:center;">${product.uid}</td>
	<td style="text-align:center;">${product.title}</td>
	<td style="text-align:center;">${product.description}</td>
	<td style="text-align:center;">${product.category}</td>
	<td style="text-align:center;">${product.price}</td>

	<td style="text-align:center;"><script>donation(${product.isDonation});</script></td>
	<td style="text-align:center;">${product.image}</td>
	<td style="text-align:center;">
	<a href="${pageContext.request.contextPath}/admin/products/delete/${product.uid}.html"><i class="fa fa-trash-o" style="font-size:36px; color:red;"></i></i></a><br/>
	</td>
</tr>
</c:forEach>
</tbody>
